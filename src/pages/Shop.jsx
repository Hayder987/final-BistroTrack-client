...
import LoaderSppiner from "../components/LoaderSppiner";
...
const Shop = () => {
  ...
  useEffect(() => {
    axios
      .get(
        ...
        }/categoryData/${catData}?page=${currentPage}&limit=${itemPerPage}`
      )
      .then((res) => {
  ...
  return (
    <div className="mb-20">
      ...
      <div className="flex justify-center items-center p-8">
        <div className="flex items-center gap-8 md:text-2xl font-semibold">
          <button
            ...
            className={`uppercase ${
              catData === "salad" ? "border-b-4 border-orange-400" : ""
            }`}
          >
            Salad
          </button>
          <button
            ...
            className={`uppercase ${
              catData === "pizza" ? "border-b-4 border-orange-400" : ""
            }`}
          >
            pizza
          </button>
          <button
            ...
            className={`uppercase ${
              catData === "soup" ? "border-b-4 border-orange-400" : ""
            }`}
          >
            soups
          </button>
          <button
            ...
            className={`uppercase ${
              catData === "dessert" ? "border-b-4 border-orange-400" : ""
            }`}
          >
            desserts
          </button>
      ...
      {/* card */}
      {
        loading && <LoaderSppiner></LoaderSppiner>
      }
      ...
      <div className="flex py-6 justify-center items-center">
        <div className="flex justify-center items-center gap-4">
          <button
            ...
            className="p-2 bg-slate-800 text-white px-5 font-semibold rounded-lg"
          >
            Prev
          </button>
          {page.map((pageNo) => (
            <button
              ...
              className={`w-8 h-8 ${
                currentPage === pageNo
                  ...
                  : "bg-slate-200"
              } flex text-xl items-center justify-center rounded-full p-2 font-bold `}
            >
              {pageNo + 1}
            </button>
          ))}
